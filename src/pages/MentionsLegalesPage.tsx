              ...
              <div className="prose prose-lg max-w-none">
                <div className="mb-8">
                  ...
                  <p className="text-black leading-relaxed mb-6 text-[15px]">
                    Conformément aux dispositions des Articles 6-III et 19 de la Loi n°2004-575 du 21 juin 2004 pour la Confiance dans l'économie numérique, dite L.C.E.N., il est porté à la connaissance des Utilisateurs du site heritage-alg.com les présentes mentions légales.
                  </p>
                  <p className="text-black leading-relaxed mb-6 text-[15px]">
                    La connexion et la navigation sur le site heritage-alg.com par l'Utilisateur implique acceptation intégrale et sans réserve des présentes mentions légales.
                  </p>
                  <p className="text-black leading-relaxed mb-6 text-[15px]">
