          ...
          <div className="max-w-4xl mx-auto">
            ...
            <Card className="p-8 md:p-12 mb-8">
              <div className="prose prose-lg max-w-none">
                <h2 className="text-xl font-serif mb-6">1. Éditeur du site</h2>
                ...
                <h2 className="text-xl font-serif mb-6 mt-12">2. Directeur de publication</h2>
                <p className="text-gray-700 leading-relaxed mb-6 text-[15px]">
                  Le directeur de publication est [Nom du directeur de publication].
                </p>

                <h2 className="text-xl font-serif mb-6 mt-12">3. Hébergement</h2>
                <p className="text-gray-700 leading-relaxed mb-6 text-[15px]">
                ...
                <h2 className="text-xl font-serif mb-6 mt-12">4. Propriété intellectuelle</h2>
                <p className="text-gray-700 leading-relaxed mb-6 text-[15px]">
                ...
                <h2 className="text-xl font-serif mb-6 mt-12">5. Protection des données personnelles</h2>
                <p className="text-gray-700 leading-relaxed mb-6 text-[15px]">
                ...
                <h2 className="text-xl font-serif mb-6 mt-12">6. Cookies</h2>
                <p className="text-gray-700 leading-relaxed mb-6 text-[15px]">
                ...
                <h2 className="text-xl font-serif mb-6 mt-12">7. Responsabilité</h2>
                <p className="text-gray-700 leading-relaxed mb-6 text-[15px]">
                ...
                <h2 className="text-xl font-serif mb-6 mt-12">8. Liens hypertextes</h2>
                <p className="text-gray-700 leading-relaxed mb-6 text-[15px]">
                ...
                <h2 className="text-xl font-serif mb-6 mt-12">9. Droit applicable</h2>
                <p className="text-gray-700 leading-relaxed mb-6 text-[15px]">
